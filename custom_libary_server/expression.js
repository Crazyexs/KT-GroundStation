...
const { Parser_db, fs, sqlite3, promisify, archiver} = await import(`${dir.init}db_init.js`);
const { SerialPort, ReadlineParser, listPortsCb } = await import(`${dir.init}serial_init.js`);

export {callbackify, connect, express, app, server, io, Parser_db, fs, sqlite3, SerialPort, ReadlineParser, listPortsCb, promisify, archiver };